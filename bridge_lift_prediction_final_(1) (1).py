...
Original file is located at
    https://colab.research.google.com/drive/1Mm0RdAv4Qx-zbzBks3s4cj72Kx-IDqnr
...
st.set_page_config(page_title="Chelsea Bridge Predictor", layout="centered")
st.markdown("<h1 style='text-align: center; color: steelblue;'>Chelsea Bridge Lift Prediction</h1>", unsafe_allow_html=True)

st.metric("Mean Absolute Error", round(df["Absolute_Error"].mean(), 2))
st.metric("Predictions Within 5 Minutes", f"{df['Within_5_Minutes'].mean() * 100:.1f}%")

st.subheader("Prediction Accuracy Over Samples")
st.line_chart(df[["Actual_Lift_Duration", "Predicted_Lift_Duration"]])
